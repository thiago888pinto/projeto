    ...
    <div class="container">
        <div class="form-box login">
            <div class="subContainter">
                <h2>Fotos</h2>
                <?php
                require_once 'src/controller/fotosController.php';
        ...
        <div class="form-box register">
            <form action="src/controller/newsRegisterController.php" method="post" enctype="multipart/form-data">
                ...
                <div class="input-box">
                    <input type="text" name="materia" placeholder="Matéria" required maxlength="50">
                ...
                <div class="input-box">
                    <input type="text" name="autor" placeholder="Autor" required maxlength="50">
                ...
                <button type="submit" class="btn">Registrar Fotos</button>
            </form>
        </div>
